class Ethrex < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/lambdaclass/tap/releases/download/v1.0.1/ethrex-v1.0.1-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/lambdaclass/tap/releases/download/v1.0.1/ethrex-v1.0.1-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "c3b7051834e406b2312164d8f8844630a4d3719bd251f6c9ee61537a7276379b"
    else
      url "https://github.com/lambdaclass/tap/releases/download/v1.0.1/ethrex-v1.0.1-x86_64-unknown-linux-gnu.tar.gz"
